(function (b) {
  ...
  ((a.modules = {}),
      ...
      ((b = a("/GIFEncoder.js", d)),
        (c = function (a) {
          ...
          return (
            ...
            c.setPreserveColors(a.preserveColors),
            c.addFrame(a.data),
            a.last && c.finish(),
            (d = c.stream()),
            (a.data = d.pages),
    ...
    a.define("/GIFEncoder.js", function (e, i, j, k) {
      function c() {
      ...
      ((c.prototype.newPage = function () {
        ...
        (b.prototype.analyzePixels = function () {
          ...
          if (this.preserveColors) {
            var i = this.toRGBComponents(this.transparent);
            a = new g(this.pixels, this.sample, i);
          } else a = new f(this.pixels, this.sample);
        ...
        (b.prototype.toRGBComponents = function (a) {
          var b = null;
          return (
            a &&
              (b = {
        ...
        (b.prototype.findClosest = function (b) {
          ...
          var j = (b & 16711680) >> 16,
            ...
            c = 0,
            d = 16777216,
            m = this.colorTab.length;
          for (var a = 0; a < m; ) {
            var e = j - (this.colorTab[a++] & 255),
              f = k - (this.colorTab[a++] & 255),
              g = l - (this.colorTab[a] & 255),
              h = e * e + f * f + g * g,
              i = parseInt(a / 3),
              n = this.preserveColors || this.usedEntry[i];
            (n && h < d && ((d = h), (c = i)), a++);
          }
          return c;
        }),
      ...
      function f(x, y, z, A) {
        ...
        function C(y, p) {
          ...
          a: while ((t = w()) != c) {
            ...
            (l(e, p), (e = t), i < 1 << b ? ((n[d] = i++), (f[d] = g)) : B(p));
          }
          (l(e, p), l(s, p));
        }
        function D(a) {
        ...
        function v(a) {
          h > 0 && (a.writeByte(h), a.writeBytes(q, 0, h), (h = 0));
        }
        function o(a) {
          return (1 << a) - 1;
        }
        ...
        function l(a, c) {
          ...
          while (e >= 8) (t(g & 255, c), (g >>= 8), (e -= 8));
          if (
            ((i > m || j) &&
              (j
                ? ((m = o((n_bits = r))), (j = !1))
                : (++n_bits, n_bits == b ? (m = 1 << b) : (m = o(n_bits)))),
            a == s)
          ) {
            while (e > 0) (t(g & 255, c), (g >>= 8), (e -= 8));
            v(c);
          }
        }
        var p = Math.max(2, A),
      ...
      function c(c, d, b) {
        ((this.pixels = c),
          ...
          (this.buildColormap = function () {
            ...
            b && this.addColorToPalette(b.r, b.g, b.b);
          }),
          (this.addColorToPalette = function (c, d, e) {
            var b = a(c, d, e);
            this.paletteIndex.hasOwnProperty(b) ||
              (this.palette.push(c),
              this.palette.push(d),
              this.palette.push(e),
              (this.paletteIndex[b] = this.palette.length / 3 - 1));
          }),
    ...
    a.define("/TypedNeuQuant.js", function (A, D, E, F) {
      function B(y, B) {
        function C() {
          ((k = []),
            ...
            (u = new Int32Array(a)),
            (v = new Int32Array(a)),
            (A = new Int32Array(a >> 3)));
          var c, d;
          for (c = 0; c < a; c++)
            ((d = (c << (b + 8)) / a),
              (k[c] = new Float64Array([d, d, d, 0])),
              (v[c] = e / a),
              (u[c] = 0));
        }
        function D() {
          for (var c = 0; c < a; c++)
            ((k[c][0] >>= b), (k[c][1] >>= b), (k[c][2] >>= b), (k[c][3] = c));
        }
        ...
        function G(p, q, r) {
          ...
          for (c = 0; c < a; c++)
            ((h = k[c]),
              (i =
                Math.abs(h[0] - p) + Math.abs(h[1] - q) + Math.abs(h[2] - r)),
              i < e && ((e = i), (d = c)),
              (n = i - (u[c] >> (j - b))),
              n < l && ((l = n), (m = c)),
              (o = v[c] >> g),
        ...
        function H() {
          var d,
            ...
            j = 0;
          for (d = 0; d < a; d++) {
            for (e = k[d], h = d, g = e[1], b = d + 1; b < a; b++)
              ((c = k[b]), c[1] < g && ((h = b), (g = c[1])));
            if (
              ((c = k[h]),
              d != h &&
                ((b = c[0]),
              ...
              for (l[f] = (j + d) >> 1, b = f + 1; b < g; b++) l[b] = d;
              ((f = g), (j = d));
            }
          }
          for (l[f] = (j + i) >> 1, b = f + 1; b < 256; b++) l[b] = i;
        }
        function I(j, i, m) {
          var b,
            d,
        ...
        function L() {
          var b = [],
            g = [];
          for (var c = 0; c < a; c++) g[k[c][3]] = c;
          var d = 0;
          for (var e = 0; e < a; e++) {
            var f = g[e];
            ((b[d++] = k[f][0]), (b[d++] = k[f][1]), (b[d++] = k[f][2]));
          }
          return b;
        }
        var k, l, u, v, A;
        ((this.buildColormap = K),
          (this.getColormap = L),
          (this.lookupRGB = I));
      }
      var r = 100,
