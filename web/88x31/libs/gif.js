(function (t) {
  function e(t, i) {
    ...
    var n = e.resolve(t);
    if (!n) throw Error("Failed to resolve module " + t);
    var r = {
      id: t,
      require: e,
      filename: t,
    ...
    i && i.children.push(r);
    var s = t.slice(0, t.lastIndexOf("/") + 1);
    return (
      (e.cache[t] = r.exports),
      n.call(r.exports, r, r.exports, s, t),
      (r.loaded = !0),
      (e.cache[t] = r.exports)
    );
  }
  ...
  (e.define("/gif.coffee", function (t, i, n, r) {
    ...
    ((a = e("events", t).EventEmitter),
      (s = e("/browser.coffee", t)),
      (l = (function (t) {
        function e(t) {
          var e, i;
        ...
        return (
          ...
          (e.prototype.setOptions = function (t) {
            ...
            return function (n) {
              for (e in t)
                f(t, e) && ((i = t[e]), n.push(this.setOption(e, i)));
              return n;
            }.call(this, []);
          }),
                ...
                .forEach(
                  ...
                  function (t) {
                    ...
                    return (
                      ...
                      ((i = new Worker(e.options.workerScript)).onmessage =
                        ((n = e),
                        function (t) {
                          return (
                            n.activeWorkers.splice(
                              n.activeWorkers.indexOf(i),
                              1,
                            ),
                            n.freeWorkers.push(i),
                            n.frameFinished(t.data)
                          );
                        })),
                      e.freeWorkers.push(i)
                    );
                  }),
                ),
              t
          ...
          (e.prototype.finishRendering = function () {
            var t, e, i, n, r, s, o;
            r = 0;
            for (var a = 0, h = this.imageParts.length; a < h; ++a)
              r +=
                ((e = this.imageParts[a]).data.length - 1) * e.pageSize +
                e.cursor;
            ((r += e.pageSize - e.cursor),
              ...
              (t = new Uint8Array(r)),
              (s = 0));
            for (var l = 0, f = this.imageParts.length; l < f; ++l) {
              e = this.imageParts[l];
              for (var p = 0, u = e.data.length; p < u; ++p)
                ((o = e.data[p]),
                  (i = p),
                  t.set(o, s),
                  i === e.data.length - 1
          ...
          (e.prototype.getContextData = function (t) {
            return t.getImageData(0, 0, this.options.width, this.options.height)
              .data;
          }),
          ...
          (e.prototype.getTask = function (t) {
            ...
            else if (null != t.image) i.data = this.getImageData(t.image);
    ...
    e.define("/browser.coffee", function (t, e, i, n) {
      ...
      ((a = navigator.userAgent.toLowerCase()),
        ...
        ((r = {
          ...
          version: s || parseFloat("opera" === h[1] && h[4] ? h[4] : h[2]),
          platform: {
    ...
    e.define("events", function (t, e, i, r) {
      ...
      var s = (e.EventEmitter = n.EventEmitter),
        o =
