                    ...
                    div class="main" {
                        ...
                        div class="footer" {
                            ...
                            p {
                                ...
                                "Source code "
                                a target="_blank" href="https://github.com/haylinmoore/hive/tree/main/web/www/" { "available here" }
                                ", released under the "
                                a target="_blank" href="https://github.com/haylinmoore/hive/blob/main/web/www/COPYING" { "GNU AGPLv3 license" }
                                br;
